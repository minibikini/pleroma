  ...
  def statuses(%{assigns: %{user: reading_user}} = conn, params) do
    with %User{} = user <- User.get_cached_by_nickname_or_id(params.id, for: reading_user),
      ...
      params =
        ...
        |> Map.put("pinned", params[:pinned])
        |> Map.put("exclude_reblogs", params[:exclude_reblogs])
        |> Map.put("exclude_visibilities", params[:exclude_visibilities])
        |> Map.put("only_media", params[:only_media])
